...
class AudioFeatureExtractionDatasetJob(AudioDatasetJob):
    ...
    def __init__(self, **kwargs):
        super(AudioFeatureExtractionDatasetJob, self).__init__(**kwargs)
        self.pickver_job_dataset_image_classification = PICKLE_VERSION

        self.labels_file = None

    def __setstate__(self, state):
        super(AudioFeatureExtractionDatasetJob, self).__setstate__(state)
    ...
    def json_dict(self, verbose=False):
        d = super(AudioFeatureExtractionDatasetJob, self).json_dict(verbose)
