...
class CaffeTrainTask(TrainTask):
    ...
    def __init__(self, **kwargs):
        ...
        self.digits_version = origae.__version__
    ...
    def before_run(self):
        ...
        if isinstance(self.job, origae.model.images.classification.ImageClassificationModelJob):
            self.save_files_classification()
        elif isinstance(self.job, origae.model.images.generic.GenericImageModelJob):
        ...
        if hasattr(self, "model_file"):
            if self.model_file is not None:
                stats.update({
                    ...
                    "origae version": self.digits_version
                })
